        ...
        public void loadDefaultsForRobotType(Robot.RobotType robotType) {
            ...
            switch (robotType) {
                case INTO_THE_DEEP_19429:
                    ...
                    BUCKET_SCORE_POS = .77;    BUCKET_INTAKE_POS = .18;  BUCKET_SOFT_LANDING_POS = .3;
                    BUCKET_INCREMENT_TIME = 1.0;

                    // Dumper Positions
                    DUMPER_HOME_POS = 0.59;    DUMPER_PRESCORE_POS = 0.67;    DUMPER_DUMP_POS = .918; DUMPER_HOLD_HIGH_POS = .65;
                    DUMP_TIME_MS = 325;
                ...
                case INTO_THE_DEEP_20245:
                    ...
                    // Dumper Positions
                    DUMPER_HOME_POS = .348;    DUMPER_PRESCORE_POS = .41;    DUMPER_DUMP_POS = 1.0; DUMPER_HOLD_HIGH_POS = .43;
                    DUMP_TIME_MS = 200;
