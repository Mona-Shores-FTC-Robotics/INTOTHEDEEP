...
public class DriveParams {
    ...
    public static void configureLiftBotPinpointRRParams() {
    ...
    public static void configureLiftBotDirections(MecanumDrive mecanumDrive, DriveSubsystem driveSubsystem) {
    ...
    public static void configureLinearActuatorBotPinpointRRParams() {
        MecanumDrive.PARAMS.logoFacingDirection =
                RevHubOrientationOnRobot.LogoFacingDirection.LEFT;
        MecanumDrive.PARAMS.usbFacingDirection =
                RevHubOrientationOnRobot.UsbFacingDirection.UP;
    ...
    public static void configureLinearActuatorBotDirections(MecanumDrive mecanumDrive, DriveSubsystem driveSubsystem) {
        // Set motor directions
        mecanumDrive.leftFront.setDirection(DcMotorEx.Direction.REVERSE);
        mecanumDrive.leftBack.setDirection(DcMotorEx.Direction.REVERSE);
        mecanumDrive.rightFront.setDirection(DcMotorEx.Direction.FORWARD);
