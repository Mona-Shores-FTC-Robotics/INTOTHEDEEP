...
public class LiftSubsystem extends SubsystemBase {
    ...
    public void periodic(){
        ...
        LiftStates.LIFT_TO_HIGH_CHAMBER.setLiftHeightTicks(LIFT_PARAMS.HIGH_CHAMBER_TICKS);
    ...
    public enum LiftStates {
        ZERO, SAFE, MAX, HIGH_BASKET, LOW_BASKET, LIFT_TO_HIGH_CHAMBER, LOW_CHAMBER, HOME, HANG_HIGH_CHAMBER, HANG_LOW_CHAMBER, MANUAL;
        public int ticks;
        ...
        static {
            ...
            LIFT_TO_HIGH_CHAMBER.ticks = LIFT_PARAMS.HIGH_CHAMBER_TICKS;
