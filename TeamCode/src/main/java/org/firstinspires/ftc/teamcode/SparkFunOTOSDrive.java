...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params extends MecanumDrive.Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-2.3189, -4.4275, Math.toRadians(-178.1724));
        ...
        public double linearScalar = 0.864;
        public double angularScalar = 0.991;
    }
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        otos = hardwareMap.get(SparkFunOTOSCorrected.class,"SparkFunOTOSDrive ");
        // RR localizer note:
