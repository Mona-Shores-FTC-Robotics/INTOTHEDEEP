...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params extends MecanumDrive.Params {
        ...
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-5.3886, -1.6761, Math.toRadians(0));
        ...
        public double linearScalar = 1.008;
        public double angularScalar = 0.988;
    }
