...
public class FieldConstants {
    ...
    //SPIKE MARK POSES
    public static Pose2d SPIKE_RED_1 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_RED_2 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_RED_3 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);

    public static Pose2d SPIKE_BLUE_1 = new Pose2d(-TILE-QUARTER_TILE, TILE+HALF_TILE, FACE_315_DEGREES);
    public static Pose2d SPIKE_BLUE_2 = new Pose2d(-TILE-HALF_TILE, TILE+HALF_TILE, FACE_TOWARD_RED);
    public static Pose2d SPIKE_BLUE_3 = new Pose2d(-TILE-THREE_QUARTER_TILE, TILE+HALF_TILE, FACE_225_DEGREES);

    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_1 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_2 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_3 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);

    public static Pose2d SPIKE_NEUTRAL_AUDIENCE_1 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_NEUTRAL_AUDIENCE_2 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d SPIKE_NEUTRAL_AUDIENCE_3 = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    ...
    public static Pose2d ASCENT_BLUE_BACKSTAGE = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    ...
    public static Pose2d RUNG_RED_BACKSTAGE = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d RUNG_BLUE_AUDIENCE = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
    public static Pose2d RUNG_RED_AUDIENCE = new Pose2d(-TILE-QUARTER_TILE, -TILE-HALF_TILE, FACE_45_DEGREES);
