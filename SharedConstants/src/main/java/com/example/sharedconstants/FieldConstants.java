...
//    public static Pose2d BLUE_NET_START_POSE = rotated(RED_NET_START_POSE);
   ...
   public static Pose2d CHAMBER_PRELOAD_RED_AUDIENCE = new Pose2d(-HALF_TILE, -TILE-HALF_ROBOT_LENGTH, FACE_TOWARD_BLUE);
    public static Pose2d CHAMBER_PRELOAD_BLUE_BACKSTAGE = new Pose2d(HALF_TILE, TILE+HALF_ROBOT_LENGTH, FACE_TOWARD_RED);

    public static Pose2d CHAMBER_PRELOAD_BLUE_AUDIENCE = new Pose2d(-HALF_TILE, TILE+HALF_ROBOT_LENGTH, FACE_TOWARD_RED);
