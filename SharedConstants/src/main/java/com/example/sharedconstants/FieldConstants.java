...
public class FieldConstants {
    ...
    public static Pose2d NET_BASKET_AUTO = new Pose2d(-59, -61, Math.toRadians(50)); //-48 -52
    public static Pose2d NET_BASKET_ALIGNMENT_AUTO = new Pose2d(NET_BASKET_AUTO.position.x+5, NET_BASKET_AUTO.position.y+5, Math.toRadians(50)); //-48 -5
    ...
    public static Pose2d OBS_CORNER_PICKUP_ALLIANCE_WALL = new Pose2d(3*TILE-HALF_ROBOT_WIDTH,-3*TILE+HALF_ROBOT_LENGTH+PICKUP_ROOM+1.5, ANGLE_TOWARD_BLUE);
