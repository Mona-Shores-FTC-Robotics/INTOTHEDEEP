...
public class FieldConstants {
    ...
    public static Pose2d OBS_ZONE_PICKUP_FACE_TOWARD_BLUE = new Pose2d(2*TILE+HALF_ROBOT_WIDTH, -3*TILE+HALF_ROBOT_LENGTH+PICKUP_ROOM+2, ANGLE_TOWARD_BLUE);
    ...
    public static Pose2d RIGHT_OF_CHAMBER_INTAKE_1 =  new Pose2d(TILE+HALF_TILE+1+TILE-EIGHTH_TILE-5, -TILE-4-HALF_ROBOT_LENGTH, ANGLE_TOWARD_BLUE);
    public static Pose2d RIGHT_OF_CHAMBER_INTAKE_2 =  new Pose2d(TILE+HALF_TILE+1+TILE+EIGHTH_TILE-1, -TILE-4-HALF_ROBOT_LENGTH, ANGLE_TOWARD_BLUE);
