...
public class FieldConstants {
    ...
    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_1 = new Pose2d(2*TILE, TILE, FACE_TOWARD_RED);
    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_2 = new Pose2d(2*TILE, TILE+HALF_TILE, FACE_TOWARD_RED);
    public static Pose2d SPIKE_NEUTRAL_BACKSTAGE_3 = new Pose2d(2*TILE, 2*TILE, FACE_TOWARD_RED);
