...
public class FieldConstants {
    ...
    public static Pose2d OBS_TRIANGLE_TIP_APPROACH = new Pose2d(2*TILE-HALF_TILE-HALF_ROBOT_WIDTH+2.5,-3*TILE+HALF_ROBOT_LENGTH+3.5*PICKUP_ROOM, ANGLE_TOWARD_BLUE);
