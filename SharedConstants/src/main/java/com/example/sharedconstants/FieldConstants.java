...
//    public static Pose2d NET_BASKET_WALL = new Pose2d(-2*TILE, -3*TILE+HALF_ROBOT_LENGTH, ANGLE_TOWARD_OBSERVATION);
    ...
    public static Pose2d OBS_APPROACH = new Pose2d(2*TILE+HALF_ROBOT_WIDTH,-2*TILE, ANGLE_TOWARD_BLUE);
    ...
    public static Pose2d OBS_ZONE_PICKUP_FACE_TOWARD_BLUE = new Pose2d(2*TILE+HALF_ROBOT_WIDTH, -3*TILE+HALF_ROBOT_LENGTH+PICKUP_ROOM+1.6, ANGLE_TOWARD_BLUE);
    ...
    public static Pose2d OBS_BEHIND_SPIKE_THREE = new Pose2d(3*TILE-HALF_ROBOT_WIDTH-QUARTER_TILE+1, -HALF_TILE, ANGLE_TOWARD_BLUE);
    public static Pose2d OBS_SPIKE_THREE = new Pose2d(3*TILE-HALF_ROBOT_WIDTH+.5, -TILE, ANGLE_TOWARD_BLUE);
    public static Pose2d OBS_DELIVER_SPIKE_THREE = new Pose2d(3*TILE-HALF_ROBOT_WIDTH+.5, -TILE*2-SAMPLE_LENGTH, ANGLE_TOWARD_BLUE);
