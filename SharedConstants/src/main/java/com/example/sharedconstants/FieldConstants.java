...
public class FieldConstants {
    ...
    public static Pose2d OBS_DELIVER_SPIKE_ONE_REDO = new Pose2d(2*TILE, -2*TILE-2, ANGLE_TOWARD_BLUE);
    ...
    public static Pose2d OBS_DELIVER_SPIKE_TWO_REDO = new Pose2d(2*TILE+HALF_TILE-HALF_SAMPLE_WIDTH, -2*TILE-2, ANGLE_TOWARD_BLUE);
