...
public interface RobotAdapter {
    ...
    enum ActionType {
        ...
        LEVEL_1_ASCENT,
        LEVEL_2_ASCENT,
        LEVEL_3_ASCENT, SCORE_IN_HIGH_BASKET, WAIT_FOR_SPECIMEN_INTAKE_FROM_WALL, SPECIMEN_PICKUP_RETRY, SIMPLE_DRIVE, SAMPLE_ACTUATOR_RETRACT, MOVE_ARM_IF_WE_MISSED,
    }
