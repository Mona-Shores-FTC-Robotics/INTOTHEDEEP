...
@AutoRoute
public class NET_Score_5_SamplePreload_REQUIRES_PARTNER_PRELOAD extends NET_Score_3_Sample_Preload {
    public NET_Score_5_SamplePreload_REQUIRES_PARTNER_PRELOAD(RobotAdapter robotAdapter) {
        super(robotAdapter);
    }
