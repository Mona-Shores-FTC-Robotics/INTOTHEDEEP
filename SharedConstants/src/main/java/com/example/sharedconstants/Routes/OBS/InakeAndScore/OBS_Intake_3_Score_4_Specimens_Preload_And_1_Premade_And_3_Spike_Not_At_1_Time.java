...
public class OBS_Intake_3_Score_4_Specimens_Preload_And_1_Premade_And_3_Spike_Not_At_1_Time extends OBS_Score_1_Specimen_Preload {
    ...
    public void buildRoute() {
        ...
        pickupSpecimenFromWallAndScoreLong(CHAMBER_SLOT_FIVE);
    ...
    public void pickupSpecimenFromWallAndScore(Pose2d chamberSlot) {
        obsTrajectoryActionBuilder = obsTrajectoryActionBuilder
                ...
                .afterDisp(10, robotAdapter.getAction(RobotAdapter.ActionType.DUMP_SAMPLE_IN_OBSERVATION_ZONE))
    ...
    public void pickupSpecimenFromWallAndScoreLong(Pose2d chamberSlot) {
        obsTrajectoryActionBuilder = obsTrajectoryActionBuilder
                .setTangent(ANGLE_TOWARD_RED)
                .afterDisp(0, robotAdapter.getAction(RobotAdapter.ActionType.GET_READY_FOR_SPECIMEN_INTAKE_FROM_WALL))
                .splineToLinearHeading(OBS_APPROACH, ANGLE_TOWARD_RED)
                .splineToLinearHeading(OBS_ZONE_PICKUP_FACE_TOWARD_BLUE,ANGLE_TOWARD_RED, slowVelocity, slowAcceleration)
                .waitSeconds(.1)
                .splineToLinearHeading(chamberSlot,ANGLE_TOWARD_BLUE)
                .stopAndAdd(robotAdapter.getAction(RobotAdapter.ActionType.HANG_SPECIMEN_ON_HIGH_CHAMBER));
