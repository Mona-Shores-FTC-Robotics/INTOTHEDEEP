...
public class NET_Score_5_Sample_Preload_Submersible_Grab extends NET_Score_3_Sample_Preload {
    ...
    private void grabFromSubmersible() {
        netTrajectoryActionBuilder = netTrajectoryActionBuilder
...
//                .splineToLinearHeading(NEXT_TO_NET_ASCENT, ANGLE_TOWARD_OBSERVATION, fastVelocity, fastAcceleration)
                .afterDisp(25, robotAdapter.getAction(GET_READY_FOR_SAMPLE_INTAKE_FROM_GROUND))
                .splineToLinearHeading(NET_ASCENT, ANGLE_TOWARD_OBSERVATION, normalVelocity, normalAcceleration)
                .stopAndAdd(robotAdapter.getAction(PICKUP_FROM_GROUND))  //go fishing?
                .waitSeconds(.6);
    }
