...
public class OBS___Score___Push___Five_NeutralScoreFour_Specimens extends OBS___Score___Push___Four_NeutralScoreFour_Specimens {

    public OBS___Score___Push___Five_NeutralScoreFour_Specimens(RobotAdapter robotAdapter) {
        super(robotAdapter);
        obsTrajectoryActionBuilder = obsTrajectoryActionBuilder
                ...
                .setReversed(true)
                .splineToLinearHeading(CHAMBER_SLOT_SIX, ANGLE_TOWARD_BLUE)
