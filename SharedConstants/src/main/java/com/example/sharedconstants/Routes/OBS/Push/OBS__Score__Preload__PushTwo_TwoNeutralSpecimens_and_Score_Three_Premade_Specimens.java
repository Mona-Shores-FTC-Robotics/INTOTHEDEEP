...
public class OBS__Score__Preload__PushTwo_TwoNeutralSpecimens_and_Score_Three_Premade_Specimens extends OBS_Score_Preload_Push_Two_Neutral_Specimens_and_Score_Two_Premade_Specimens {

    public OBS__Score__Preload__PushTwo_TwoNeutralSpecimens_and_Score_Three_Premade_Specimens(RobotAdapter robotAdapter) {
        super(robotAdapter);
